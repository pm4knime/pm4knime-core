...
public class SMXLogImporter extends SettingsModel {
	...
	public SMXLogImporter(final String configName, final Importer defaultValue) {
	...
	@Override
	protected SMXLogImporter createClone() {
		return new SMXLogImporter(configName, importer);
	}
