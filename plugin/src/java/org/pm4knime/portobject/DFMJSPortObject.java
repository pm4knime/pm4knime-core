...
public class DFMJSPortObject extends AbstractPortObject {

	public static final PortType TYPE = PortTypeRegistry.getInstance().getPortType(DFMJSPortObject.class);
	private static final String ZIP_ENTRY_NAME = "DFMPortObject";
	Dfg dfm;
	DFMPortObjectSpec m_spec;
	public DFMJSPortObject() {
	}

	public DFMJSPortObject(Dfg dfm) {
		this.dfm = dfm;
	}
...
//			long[] edgeIndices = (long[]) objIn.readObject();
	...
	public static final class DFMJSPortObjectSerializer extends AbstractPortObjectSerializer<DFMJSPortObject> {
	}
