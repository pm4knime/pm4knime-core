...
import org.pm4knime.util.ui.DefaultMinerNodeModel;
...
public class InductiveMinerNodeModel2 extends DefaultMinerNodeModel {
    ...
    private static final NodeLogger logger = NodeLogger
            .getLogger(InductiveMinerNodeModel2.class);
	...
	private SettingsModelString m_type =  new SettingsModelString(InductiveMinerNodeModel.CFGKEY_METHOD_TYPE, defaultType[1]);
	...
	protected InductiveMinerNodeModel2() {
    	super(new PortType[] { XLogPortObject.TYPE },
				new PortType[] { ProcessTreePortObject.TYPE });
    }
	...
	protected PortObject mine(XLog log) throws Exception{
		...
		// as one parameter, and no need to explicitly infer the classifier from it ?? Now, it is just fine
