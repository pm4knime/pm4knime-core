...
public class DFMPortObject2 extends AbstractPortObject  {

	public static final PortType TYPE = PortTypeRegistry.getInstance().getPortType(DFMPortObject2.class);
	private static final String ZIP_ENTRY_NAME = "DFMPortObject2";
	DirectlyFollowsModel dfm;
	DFMPortObjectSpec m_spec;
	public DFMPortObject2() {
	}

	public DFMPortObject2(DirectlyFollowsModel dfm) {
		this.dfm = dfm;
	}
	...
	public JComponent[] getViews() {
		...
		JComponent viewPanel = DirectlyFollowsModelVisualisationPlugin.fancy(dfm);
	...
	public DotPanel getDotPanel() {
		...
		if(dfm != null) {
				...
				DotPanel navDot;
				navDot = DfgMsdVisualisationPlugin.fancy((DirectlyFollowsGraph)dfm);
...
//			long[] edgeIndices = (long[]) objIn.readObject();
	...
	public static final class DFMPortObject2Serializer extends AbstractPortObjectSerializer<DFMPortObject2> {
	}
}
