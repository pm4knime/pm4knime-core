 ...
 */
public class CSV2XLogConfigSettingsModel extends SettingsModel{
	...
	public CSV2XLogConfigSettingsModel(final String configName) {
	...
	@Override
	protected CSV2XLogConfigSettingsModel createClone() {
		return new CSV2XLogConfigSettingsModel(m_configName);
	}
	@Override
