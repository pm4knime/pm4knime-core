 ...
 */
public class Table2XLogConfigSettingsModel extends SettingsModel{
	...
	public Table2XLogConfigSettingsModel(final String configName) {
	...
	/*
	 * copy only the name there not the other values there.
	 */
	@SuppressWarnings("unchecked")
	@Override
	protected Table2XLogConfigSettingsModel createClone() {
		return new Table2XLogConfigSettingsModel(m_configName);
	}
	@Override
	protected String getModelTypeID() {
		// TODO Auto-generated method stub
		return "CSV2XLog Coonvertor Config Model";
	}
	@Override
