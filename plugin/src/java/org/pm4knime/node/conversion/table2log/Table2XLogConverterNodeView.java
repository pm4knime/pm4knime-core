...
public class Table2XLogConverterNodeView extends NodeView<Table2XLogConverterNodeModel> {

	protected Table2XLogConverterNodeView(int viewIndex, Table2XLogConverterNodeModel nodeModel) {
		super(nodeModel);
