...
/**
 * <code>NodeModel</code> for the "XesGezImporter" node.
 *
 * @author tbd
 */
public class XesGzImporterNodeModel extends DefaultNodeModel {
    
	private static final NodeLogger LOGGER = NodeLogger.getLogger(XesGzImporterNodeModel.class);
     ...
     */
    protected XesGzImporterNodeModel() {
