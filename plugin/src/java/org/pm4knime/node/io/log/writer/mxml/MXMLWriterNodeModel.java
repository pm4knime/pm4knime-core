...
public class MXMLWriterNodeModel extends DefaultNodeModel {
	private final NodeLogger logger = NodeLogger.getLogger(MXMLWriterNodeModel.class);
    ...
    protected MXMLWriterNodeModel(final NodeCreationConfiguration creationConfig) {
	...
	public void checkFileExtension() throws InvalidSettingsException {
    	...
    	if (compress) {
        	if (!outputPath.toString().endsWith(".mxml.gz")) {
        		throw new InvalidSettingsException(
    	                "Invalid file extension! .mxml.gz is expected!");
        	}
        } else {
        	if (!outputPath.toString().endsWith(".mxml")) {
    			throw new InvalidSettingsException(
    	                "Invalid file extension! .mxml is expected!");
        	}
        }  	
