...
public class MXMLWriterNodeDialog extends NodeDialogPane {

	DialogComponentWriterFileChooser m_filePanel;
    private MXMLWriterNodeModel model;
	private static final String FILE_HISTORY_ID = "MXML_reader_writer";
	
	
    protected MXMLWriterNodeDialog(final NodeCreationConfiguration creationConfig, MXMLWriterNodeModel model) {
    	this.model = model;
	...
	private JPanel createMainOptionsPanel(NodeCreationConfiguration creationConfig) {
        ...
        gbc.gridy++;
        mainOptionsPanel.add(model.m_compressWithGzipChecker, gbc);
