...
public class XESWriterNodeDialog extends NodeDialogPane {

	DialogComponentWriterFileChooser m_filePanel;
    private XESWriterNodeModel model;
	private static final String FILE_HISTORY_ID = "xes_reader_writer";
	
	
    protected XESWriterNodeDialog(final NodeCreationConfiguration creationConfig, XESWriterNodeModel model) {
    	this.model = model;
