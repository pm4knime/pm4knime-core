...
public class ProcessTreeWriterNodeDialog extends NodeDialogPane {

	DialogComponentWriterFileChooser m_filePanel;
    private ProcessTreeWriterNodeModel model;
	private static final String FILE_HISTORY_ID = "ProcessTree_reader_writer";
	
	
    protected ProcessTreeWriterNodeDialog(final NodeCreationConfiguration creationConfig, ProcessTreeWriterNodeModel model) {
    	this.model = model;
