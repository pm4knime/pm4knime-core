 ...
 * @author 
 */
public class JSGraphVizPNNodeView extends NodeView<JSGraphVizPNNodeModel> {
     ...
     */
    protected JSGraphVizPNNodeView(JSGraphVizPNNodeModel nodeModel) {
        super(nodeModel);
    ...
    protected void modelChanged() {
        ...
        // update the view.
        JSGraphVizPNNodeModel nodeModel = 
            (JSGraphVizPNNodeModel)getNodeModel();
