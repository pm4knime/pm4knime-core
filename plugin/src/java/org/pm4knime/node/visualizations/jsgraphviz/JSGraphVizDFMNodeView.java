 ...
 * @author 
 */
public class JSGraphVizDFMNodeView extends NodeView<JSGraphVizDFMNodeModel> {
     ...
     */
    protected JSGraphVizDFMNodeView(JSGraphVizDFMNodeModel nodeModel) {
        super(nodeModel);
    ...
    protected void modelChanged() {
        ...
        // update the view.
        JSGraphVizDFMNodeModel nodeModel = 
            (JSGraphVizDFMNodeModel)getNodeModel();
