...
/**
 * <code>NodeView</code> for the "UnifiedConformanceChecker" node.
 *
 * @author Kefang Ding
 */
public class UnifiedConformanceCheckerNodeView extends NodeView<UnifiedConformanceCheckerNodeModel> {

	/**
	 * Creates a new view.
	 *
	 * @param nodeModel The model (class:
	 *                  {@link UnifiedConformanceCheckerNodeModel})
	 */
	protected UnifiedConformanceCheckerNodeView(final UnifiedConformanceCheckerNodeModel nodeModel) {
		super(nodeModel);
