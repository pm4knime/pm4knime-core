...
public class ManifestEvClassPatternTable  extends ManifestTable {
	private TransClass2PatternMapTable transClass2PatternMap;
	...
	public ManifestEvClassPatternTable(PetrinetGraph net, Marking initMarking, Marking[] finalMarkings, TableEventLog log,
			...
			TransClass2PatternMapTable transClass2PatternMap, TIntIntMap index2FitnessStats, int[] manifest2PatternID,
			double[] fitnessStats) {
	 ...
	 */
	public TransClass2PatternMapTable getTransClass2PatternMap() {
		return transClass2PatternMap;
	}

	public String[] getEventClassesOfPattern(short patternID) {
