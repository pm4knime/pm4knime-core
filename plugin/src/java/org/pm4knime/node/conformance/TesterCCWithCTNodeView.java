...
/**
 * <code>NodeView</code> for the "TesterCCWithCT" node.
 *
 * @author Kefang Ding
 */
public class TesterCCWithCTNodeView extends NodeView<TesterCCWithCTNodeModel>  {

	// it has the same function, so we extends it here
	protected TesterCCWithCTNodeView(TesterCCWithCTNodeModel nodeModel) {
		super(nodeModel);
