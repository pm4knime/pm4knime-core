...
public class PM4KNIMEPluginDescriptor extends AbstractPluginDescriptor {
	...
	public PM4KNIMEPluginDescriptor(Method method, PackageDescriptor pack) throws Exception {
		assert (method != null);
		...
		//		System.out.println("RapidProMPluginDescriptorImpl,\"" + name + "\",\"" + (pack == null ? "" : pack.getName()) + "\"");
	...
	public PM4KNIMEPluginDescriptor(Class<?> type, Class<? extends PluginContext> acceptedContext, PackageDescriptor pack)
			throws Exception {
		assert (type != null);
	...
	public PM4KNIMEPluginDescriptor(String className, String name, Class<?>[] parTypes, PackageDescriptor pack) throws Exception {
	...
	public boolean equals(Object other) {
		if (!(other instanceof PM4KNIMEPluginDescriptor)) {
			return false;
		}
		PM4KNIMEPluginDescriptor otherDesc = (PM4KNIMEPluginDescriptor) other;
